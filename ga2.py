...
def crossoverPopulation(matingpool, eliteSize, crossoverRate):
	children = []
	...
	for i in range(0, length):
		if (random.random() < crossoverRate):
			...
			children.append(pool[len(matingpool) - i - 1])
	return children
...
def nextGeneration(currentGen, eliteSize, crossoverRate, mutationRate):
	...
	children = crossoverPopulation(matingpool, eliteSize, crossoverRate)
...
def geneticAlgorithm(population, popSize, eliteSize, crossoverRate, mutationRate, generations):
	...
	for i in range(0, generations):
		...
		print("Step distance: " + str(1 / rankRoutes(pop)[0][1]))
